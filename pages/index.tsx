...
const Home = () => {
    return <>
        <Head>
            ...
            <meta name="description" content="Portland AI, a leading AI consulting firm, helps small and medium-sized businesses in integrating and leveraging AI technologies effectively to boost profitability, efficiency, and customer satisfaction." />
            <meta name="keywords" content="AI Consulting, AI Integration, AI Deployment, AI in Business, Portland AI, Large Language Models, AI for SMBs" />
            <meta name="author" content="Portland AI" />
            <meta property="og:title" content="Portland AI" />
            <meta property="og:description" content="Portland AI, a leading AI consulting firm, helps small and medium-sized businesses in integrating and leveraging AI technologies effectively to boost profitability, efficiency, and customer satisfaction." />
            <meta property="og:image" content="https://portlandai.io/portlandai.png" />
            <meta property="og:url" content="https://portlandai.io" />
            <meta property="og:site_name" content="Portland AI" />
            <meta name="twitter:card" content="summary_large_image" />
            <meta name="twitter:title" content="Portland AI" />
            <meta name="twitter:description" content="Portland AI, a leading AI consulting firm, helps small and medium-sized businesses in integrating and leveraging AI technologies effectively to boost profitability, efficiency, and customer satisfaction." />
            <meta name="twitter:image" content="https://portlandai.io/portlandai.png" />
        </Head>
        <div className="">
            <div className="bg-[url('/background.webp')] bg-cover bg-no-repeat bg-opacity-30 absolute top-0 left-0 w-[100%] h-[100vh] x-[-1]"></div>
            <div className="bg-main-950 bg-opacity-70 absolute top-0 left-0 w-[100%] h-[100vh]"></div>
            <div className="relative z-10">
                <div className="">
                    ...
                    <div className="bg-lt-100 text-dk py-16 md:py-32 md:space-y-32">
                        ...
                        <div id="about" className="text-lt mt-[-200px] md:pt-0">
                            <div className="md:grid grid-cols-7">
                                ...
                                <div className="bg-main-950 pt-[300px] col-span-4 p-8 md:p-16 md:pl-32 space-y-4 md:z-[1] md:relative">
                    ...
                    <div id="navigating-ai" className="grid grid-cols-1 md:grid-cols-2 gap-0">
                        <div className="bg-main-950 px-4 py-8 md:py-16">
                    ...
                    <div id="contact" className="bg-main-950 p-4 text-lt md:py-16">
                        <SafeArea className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            ...
                            <div className={createTheme({
                                ...
                                <Collapse.Group bordered>
                                    <Collapse title="How does AI integration work with my existing business processes?">
                                        <p>At Portland AI, we implement AI technologies in a phased approach to minimize disruption. We first evaluate your existing workflows, identify areas where AI can enhance efficiency or outcomes, and then custom design solutions that smoothly integrate with your operations.</p>
                                    </Collapse>
                                    <Collapse title="What kind of return on investment can I expect from implementing AI solutions?">
                                        <p>While the ROI can vary based on specific use-cases, AI solutions generally lead to increased efficiency, reduced operational costs, and improved customer experiences. Our clients typically start seeing positive returns within 6-12 months of implementation, with continued growth over time.</p>
                                    </Collapse>
                                    <Collapse title="How is the privacy and security of my data ensured when using AI technologies?">
                                        <p>Portland AI adheres to stringent data security protocols and complies with all relevant privacy regulations. We ensure that all AI solutions we deploy are designed with robust security measures, and we only use data for the agreed-upon purposes. Your privacy and security are our top priorities.</p>
                                    </Collapse>
                                </Collapse.Group>
                            </div>
                        </SafeArea>
